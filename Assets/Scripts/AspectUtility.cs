...
public class AspectUtility : MonoBehaviour {
	...
	/* Script para mantener la proporcion y el aspecto 
	 * de la cámara en cualquier dispositivo
	 * es decir mantiene la relación de aspecto
	 * Este script lo debes meter en el proyecto y asociarselo
	 * a Main Camara
	*/
